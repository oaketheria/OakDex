...
const content = {
  "/sobre.html": {
    pt: {
      ...
      nav: ["Home", "OakDuo", "Oak Challenge", "Oak Rogue", "Sobre o Projeto", "Como Usar", "Patch Notes"],
      heroKicker: "OakRom",
      heroTitle: "Sobre o Projeto",
      heroCopy: "OakRom é uma central local para jogar, organizar e transmitir ROMs no navegador, com OakBit, OakDuo, Oak Challenge, Oak Rogue, Pokédex integrada e uma interface inspirada em arcades.",
      cards: [
        ...
        ["Oak Rogue", "Oak Rogue transforma a rota em um roguelike de ginasios, com mapa ramificado, combate automatico, reliquias, modo normal e Nuzlocke."],
    ...
    en: {
      ...
      nav: ["Home", "OakDuo", "Oak Challenge", "Oak Rogue", "About the Project", "How to Use", "Patch Notes"],
      heroKicker: "OakRom",
      heroTitle: "About the Project",
      heroCopy: "OakRom is a local hub for playing, organizing, and streaming ROMs in the browser, with OakBit, OakDuo, Oak Challenge, Oak Rogue, an integrated Pokedex, and an arcade-inspired interface.",
      cards: [
        ...
        ["Oak Rogue", "Oak Rogue turns routes into a gym roguelike with branching maps, automatic battles, relics, normal mode, and Nuzlocke mode."],
  ...
  "/como-usar.html": {
    pt: {
      ...
      heroTitle: "Como Usar",
      heroCopy: "Comece pela Home, organize suas ROMs, abra o emulador, use o OakBit como assistente e escolha entre jogar sozinho, em dupla no OakDuo, em modo desafio no Oak Challenge ou no roguelike Oak Rogue.",
      cards: [
        ...
        ["Suba a torre roguelike", "No Oak Rogue, escolha modo normal ou Nuzlocke, recrute aliados, equipe reliquias, enfrente NPCs e lideres e avance pelo mapa ramificado."],
    ...
    en: {
      ...
      heroCopy: "Start from Home, organize your ROMs, open the emulator, use OakBit as an assistant, and choose between solo play, OakDuo, Oak Challenge, or the Oak Rogue roguelike.",
      cards: [
        ...
        ["Climb the roguelike tower", "In Oak Rogue, choose normal or Nuzlocke mode, recruit allies, equip relics, fight NPCs and leaders, and advance through the branching map."],
  ...
  "/patch-notes.html": {
    pt: {
      ...
      heroCopy: "Histórico das atualizações recentes do OakRom, incluindo OakDuo, OakBit, Home, página da ROM, tela do emulador, Pokédex integrada, Oak Challenge, Oak Rogue e melhorias da biblioteca.",
      cards: [],
    },
    en: {
      title: "Patch Notes - OakRom",
      ...
      heroKicker: "Changelog",
      heroTitle: "Patch Notes",
      heroCopy: "Recent OakRom update history, including OakDuo, OakBit, Home, the ROM page, emulator screen, integrated Pokedex, Oak Challenge, Oak Rogue, and library improvements.",
      cards: [],
    },
  },
};
